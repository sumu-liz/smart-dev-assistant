const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./iblVoxelGrid3dDebug.fragment-BR97I6Y6.js","./index-CxR0Yf_7.js","./index-BvBk1Iap.js","./index-CrbFh6qt.css","./iblVoxelGrid3dDebug.fragment-UVv_R2wF.js","./copyTexture3DLayerToTexture.fragment-zqFhlNS6.js","./copyTexture3DLayerToTexture.fragment-BTOY3Z2F.js","./iblCombineVoxelGrids.fragment-Bl-6qCup.js","./iblCombineVoxelGrids.fragment-DsGv1BAC.js","./iblGenerateVoxelMip.fragment-CTzvKAkh.js","./iblGenerateVoxelMip.fragment-1zhj6wrV.js","./iblVoxelGrid.fragment-BcvnLLez.js","./iblVoxelGrid.vertex-Dmys60bF.js","./morphTargetsVertexDeclaration-BLOFnJa5.js","./bonesVertex-b_UrNN_W.js","./bakedVertexAnimation-CnIdycvp.js","./iblVoxelGrid.fragment-DL2on1KD.js","./iblVoxelGrid.vertex-ChKJvWv-.js","./bakedVertexAnimation-HQ8JUcrA.js","./instancesDeclaration-Bv0KzShp.js","./morphTargetsVertex-C9IVzlEb.js","./iblVoxelSlabDebug.fragment-DK2alanR.js","./iblVoxelSlabDebug.vertex-DAR9S5Bo.js","./iblVoxelSlabDebug.fragment-Db1Xw7Uq.js","./iblVoxelSlabDebug.vertex-BTzcvRiS.js","./iblShadowDebug.fragment-yYOPI3BZ.js","./iblShadowDebug.fragment-BKC_4YzP.js","./iblShadowVoxelTracing.fragment-CglMLVwJ.js","./iblShadowVoxelTracing.fragment-CqNd_xRl.js","./iblShadowSpatialBlur.fragment-C7LJ3F1I.js","./iblShadowSpatialBlur.fragment-CguHnx3x.js","./iblShadowAccumulation.fragment-CiVe59Nx.js","./iblShadowAccumulation.fragment-BVF6KOQ_.js","./pass.fragment-3ZtXZEEf.js","./pass.fragment-DRi-TRdO.js","./iblShadowGBufferDebug.fragment-lPIKS-Qj.js","./iblShadowGBufferDebug.fragment-D6P1u55e.js"])))=>i.map(i=>d[i]);
import { af as __vitePreload } from './index-BvBk1Iap.js';
import { aL as RenderTargetTexture, aA as PostProcess, b9 as Color4, O as Observable, M as Matrix, ai as Vector4, L as Logger, aD as EffectRenderer, aE as EffectWrapper, T as Texture, bz as MultiRenderTarget, bn as Engine, V as Vector3, bC as MaterialPluginBase, bD as PBRBaseMaterial, ac as MaterialDefines, _ as __decorate, s as serialize, ae as expandToProperty, R as RegisterClass, aq as EngineStore, ao as Quaternion, d as Tools } from './index-CxR0Yf_7.js';
import { ShaderMaterial } from './shaderMaterial-UCHwgcla.js';
import { P as ProceduralTexture } from './iblCdfGenerator-CtGL_NwH.js';
import { G as GeometryBufferRenderer } from './geometryBufferRenderer-Dvq35Qkr.js';
import { P as PostProcessRenderPipeline, a as PostProcessRenderEffect } from './postProcessRenderEffect-BIXOs3xJ.js';
import { R as RawTexture } from './rawTexture-Bto4WZO2.js';
import { OpenPBRMaterial } from './openpbrMaterial-L3-DYNd8.js';
import { S as StandardMaterial } from './standardMaterial-BzBQSFg4.js';
import './geometryBufferRendererSceneComponent-890wIbQI.js';
import './iblCdfGeneratorSceneComponent-qXEHR64E.js';
...
class _IblShadowsVoxelRenderer {
        ...
        if (!this._voxelDebugPass) {
            const debugOptions = {
                ...
                extraInitializations: (useWebGPU, list) => {
                    if (useWebGPU) {
                        list.push(__vitePreload(() => import('./iblVoxelGrid3dDebug.fragment-BR97I6Y6.js'),true              ?__vite__mapDeps([0,1,2,3]):void 0,import.meta.url));
                    }
                    else {
                        list.push(__vitePreload(() => import('./iblVoxelGrid3dDebug.fragment-UVv_R2wF.js'),true              ?__vite__mapDeps([4,1,2,3]):void 0,import.meta.url));
                    }
                },
            };
    ...
    constructor(scene, iblShadowsRenderPipeline, resolutionExp = 6, triPlanarVoxelization = true) {
        ...
        this._copyMipEffectWrapper = new EffectWrapper({
            ...
            extraInitializationsAsync: async () => {
                if (isWebGPU) {
                    await __vitePreload(() => import('./copyTexture3DLayerToTexture.fragment-zqFhlNS6.js'),true              ?__vite__mapDeps([5,1,2,3]):void 0,import.meta.url);
                }
                else {
                    await __vitePreload(() => import('./copyTexture3DLayerToTexture.fragment-BTOY3Z2F.js'),true              ?__vite__mapDeps([6,1,2,3]):void 0,import.meta.url);
                }
            },
        });
    ...
    _createTextures() {
        ...
        const voxelCombinedOptions = {
            ...
            extraInitializationsAsync: async () => {
                if (isWebGPU) {
                    await __vitePreload(() => import('./iblCombineVoxelGrids.fragment-Bl-6qCup.js'),true              ?__vite__mapDeps([7,1,2,3]):void 0,import.meta.url);
                }
                else {
                    await __vitePreload(() => import('./iblCombineVoxelGrids.fragment-DsGv1BAC.js'),true              ?__vite__mapDeps([8,1,2,3]):void 0,import.meta.url);
                }
            },
        };
        if (this._engine.isWebGPU) {
        ...
        const generateVoxelMipOptions = {
            ...
            extraInitializationsAsync: async () => {
                if (isWebGPU) {
                    await __vitePreload(() => import('./iblGenerateVoxelMip.fragment-CTzvKAkh.js'),true              ?__vite__mapDeps([9,1,2,3]):void 0,import.meta.url);
                }
                else {
                    await __vitePreload(() => import('./iblGenerateVoxelMip.fragment-1zhj6wrV.js'),true              ?__vite__mapDeps([10,1,2,3]):void 0,import.meta.url);
                }
            },
        };
    ...
    _createVoxelMaterials() {
        ...
        this._voxelMaterial = new ShaderMaterial("voxelization", this._scene, "iblVoxelGrid", {
            ...
            extraInitializationsAsync: async () => {
                if (isWebGPU) {
                    await Promise.all([__vitePreload(() => import('./iblVoxelGrid.fragment-BcvnLLez.js'),true              ?__vite__mapDeps([11,1,2,3]):void 0,import.meta.url), __vitePreload(() => import('./iblVoxelGrid.vertex-Dmys60bF.js'),true              ?__vite__mapDeps([12,1,2,3,13,14,15]):void 0,import.meta.url)]);
                }
                else {
                    await Promise.all([__vitePreload(() => import('./iblVoxelGrid.fragment-DL2on1KD.js'),true              ?__vite__mapDeps([16,1,2,3]):void 0,import.meta.url), __vitePreload(() => import('./iblVoxelGrid.vertex-ChKJvWv-.js'),true              ?__vite__mapDeps([17,1,2,3,18,19,20]):void 0,import.meta.url)]);
                }
            },
        });
        ...
        this._voxelSlabDebugMaterial = new ShaderMaterial("voxelSlabDebug", this._scene, "iblVoxelSlabDebug", {
            ...
            extraInitializationsAsync: async () => {
                if (isWebGPU) {
                    await Promise.all([__vitePreload(() => import('./iblVoxelSlabDebug.fragment-DK2alanR.js'),true              ?__vite__mapDeps([21,1,2,3]):void 0,import.meta.url), __vitePreload(() => import('./iblVoxelSlabDebug.vertex-DAR9S5Bo.js'),true              ?__vite__mapDeps([22,1,2,3]):void 0,import.meta.url)]);
                }
                else {
                    await Promise.all([__vitePreload(() => import('./iblVoxelSlabDebug.fragment-Db1Xw7Uq.js'),true              ?__vite__mapDeps([23,1,2,3]):void 0,import.meta.url), __vitePreload(() => import('./iblVoxelSlabDebug.vertex-BTzcvRiS.js'),true              ?__vite__mapDeps([24,1,2,3]):void 0,import.meta.url)]);
                }
            },
        });
    }
...
class _IblShadowsVoxelTracingPass {
    ...
    _createDebugPass() {
        ...
        if (!this._debugPassPP) {
            const debugOptions = {
                ...
                extraInitializations: (useWebGPU, list) => {
                    if (useWebGPU) {
                        list.push(__vitePreload(() => import('./iblShadowDebug.fragment-yYOPI3BZ.js'),true              ?__vite__mapDeps([25,1,2,3]):void 0,import.meta.url));
                    }
                    else {
                        list.push(__vitePreload(() => import('./iblShadowDebug.fragment-BKC_4YzP.js'),true              ?__vite__mapDeps([26,1,2,3]):void 0,import.meta.url));
                    }
                },
            };
    ...
    _createTextures() {
        ...
        const textureOptions = {
            ...
            extraInitializationsAsync: async () => {
                if (isWebGPU) {
                    await Promise.all([__vitePreload(() => import('./iblShadowVoxelTracing.fragment-CglMLVwJ.js'),true              ?__vite__mapDeps([27,1,2,3]):void 0,import.meta.url)]);
                }
                else {
                    await Promise.all([__vitePreload(() => import('./iblShadowVoxelTracing.fragment-CqNd_xRl.js'),true              ?__vite__mapDeps([28,1,2,3]):void 0,import.meta.url)]);
                }
            },
        };
...
class _IblShadowsSpatialBlurPass {
    ...
    _createTextures() {
        ...
        const textureOptions = {
            ...
            extraInitializationsAsync: async () => {
                if (isWebGPU) {
                    await Promise.all([__vitePreload(() => import('./iblShadowSpatialBlur.fragment-C7LJ3F1I.js'),true              ?__vite__mapDeps([29,1,2,3]):void 0,import.meta.url)]);
                }
                else {
                    await Promise.all([__vitePreload(() => import('./iblShadowSpatialBlur.fragment-CguHnx3x.js'),true              ?__vite__mapDeps([30,1,2,3]):void 0,import.meta.url)]);
                }
            },
        };
...
class _IblShadowsAccumulationPass {
    ...
    _createTextures() {
        ...
        const outputTextureOptions = {
            ...
            extraInitializationsAsync: async () => {
                if (isWebGPU) {
                    await Promise.all([__vitePreload(() => import('./iblShadowAccumulation.fragment-CiVe59Nx.js'),true              ?__vite__mapDeps([31,1,2,3]):void 0,import.meta.url)]);
                }
                else {
                    await Promise.all([__vitePreload(() => import('./iblShadowAccumulation.fragment-BVF6KOQ_.js'),true              ?__vite__mapDeps([32,1,2,3]):void 0,import.meta.url)]);
                }
            },
        };
        ...
        const accumulationOptions = {
            ...
            extraInitializationsAsync: async () => {
                if (isWebGPU) {
                    await Promise.all([__vitePreload(() => import('./pass.fragment-3ZtXZEEf.js'),true              ?__vite__mapDeps([33,1,2,3]):void 0,import.meta.url)]);
                }
                else {
                    await Promise.all([__vitePreload(() => import('./pass.fragment-DRi-TRdO.js'),true              ?__vite__mapDeps([34,1,2,3]):void 0,import.meta.url)]);
                }
            },
        };
...
class IblShadowsRenderPipeline extends PostProcessRenderPipeline {
    ...
    _getGBufferDebugPass() {
        ...
        const options = {
            ...
            extraInitializations: (useWebGPU, list) => {
                if (useWebGPU) {
                    list.push(__vitePreload(() => import('./iblShadowGBufferDebug.fragment-lPIKS-Qj.js'),true              ?__vite__mapDeps([35,1,2,3]):void 0,import.meta.url));
                }
                else {
                    list.push(__vitePreload(() => import('./iblShadowGBufferDebug.fragment-D6P1u55e.js'),true              ?__vite__mapDeps([36,1,2,3]):void 0,import.meta.url));
                }
            },
        };
...
//# sourceMappingURL=iblShadowsRenderPipeline-DAE0T-2u.js.map
